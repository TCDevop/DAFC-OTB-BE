...
function randDec(min, max, decimals = 2) {
...
async function main() {
    ...
    const budgetDefs = [
        { budgetCode: 'BUD-FER-SS-Pre-2026', groupBrandId: brandFER.id, seasonGroupId: 'SS', seasonType: 'pre', fiscalYear: 2026, totalBudget: 5_000_000_000, status: 'APPROVED' },
        { budgetCode: 'BUD-FER-SS-Main-2026', groupBrandId: brandFER.id, seasonGroupId: 'SS', seasonType: 'main', fiscalYear: 2026, totalBudget: 8_500_000_000, status: 'APPROVED' },
        { budgetCode: 'BUD-BUR-FW-Pre-2026', groupBrandId: brandBUR.id, seasonGroupId: 'FW', seasonType: 'pre', fiscalYear: 2026, totalBudget: 6_200_000_000, status: 'APPROVED' },
        { budgetCode: 'BUD-GUC-SS-Pre-2026', groupBrandId: brandGUC.id, seasonGroupId: 'SS', seasonType: 'pre', fiscalYear: 2026, totalBudget: 12_000_000_000, status: 'LEVEL1_APPROVED' },
        { budgetCode: 'BUD-PRA-FW-Main-2026', groupBrandId: brandPRA.id, seasonGroupId: 'FW', seasonType: 'main', fiscalYear: 2026, totalBudget: 7_800_000_000, status: 'SUBMITTED' },
        { budgetCode: 'BUD-FER-FW-Pre-2026', groupBrandId: brandFER.id, seasonGroupId: 'FW', seasonType: 'pre', fiscalYear: 2026, totalBudget: 4_500_000_000, status: 'APPROVED' },
    ];
    const budgets = {};
    const budgetDetails = {};
    ...
    function buildProduct(skuCode, collection, gender, category, subCategory, unitCostPct, orderQty, customerTarget, sortOrder) {
    ...
    for (const fy of allocYears) {
        for (const as of allocSeasons) {
            const baseBudget = rand(3, 10) * 1_000_000_000;
    ...
    for (const sb of snapshotBudgets) {
        ...
        for (let dayOffset = 13; dayOffset >= 0; dayOffset--) {
            const progress = (13 - dayOffset) / 13;
...
//# sourceMappingURL=seed-rich.js.map